const stripe = require('stripe')(process.env.STRIPE_SCRIPT)
...
exports.createCashOrder = asyncHandler(async(req,res,next)=>
    {
        ...
        //2) Get order price depend on cartPrice "check if coupon apply"
        const cartPrice = cart.totalPriceAfterDiscount ? cart.totalPriceAfterDiscount: cart.totalCartPrice; 
        const totalOrderPrice = cartPrice + taxPrice + shippingPrice;//لحساب الضريبة وتكلفة الشحن ان وجدو
